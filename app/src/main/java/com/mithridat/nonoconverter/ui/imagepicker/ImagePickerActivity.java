...
/**
 * Class com.nguyenhoanglam.imagepicker.ui.imagepicker.ImagePickerActivity
 * with animation transitions. This is activity for pick image from the gallery.
 */
public class ImagePickerActivity extends AppCompatActivity implements ImagePickerView {
    ...
    public void onBackPressed() {
        recyclerViewManager.handleBack(new OnBackAction() {
            ...
            public void onFinishImagePicker() {
                ...
                finish();
                if (config.getRequestCode() == ActivitiesConstants.RC_PICK_IMAGE_START)
                    overridePendingTransition(com.mithridat.nonoconverter.R.anim.slide_in_right,
                            com.mithridat.nonoconverter.R.anim.slide_out_right);
            }
        });
    }
    ...
    public void finishPickImages(List<Image> images) {
        ...
        finish();
        Log.d("TAG", Integer.toString(config.getRequestCode()));
        if (config.getRequestCode() == ActivitiesConstants.RC_PICK_IMAGE_EDIT_IMAGE)
            overridePendingTransition(com.mithridat.nonoconverter.R.anim.slide_in_left,
                    com.mithridat.nonoconverter.R.anim.slide_out_left);
    }
}
